...
namespace Rhino.Geometry
{
    ...
    public struct Interval : ISerializable, IEquatable<Interval>, IComparable<Interval>, IComparable, IEpsilonComparable<Interval>, IValidable
    {
        ...
        /// <summary>
        /// MAp Value from reference interval to other (target)
        /// </summary>
        /// <param name="v">value to remap</param>
        /// <param name="reference">Reference Interval</param>
        /// <param name="Target">Target Interval</param>
        /// <returns></returns>
        public static double Map(double v, Interval Reference, Interval Target)
        {
            return Target.T0 + (v / Reference.Length) * Target.Length;
        }
